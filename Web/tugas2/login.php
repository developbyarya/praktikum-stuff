        ...
        if ($username == "" || $password == ""){
            ...
            if ($stmt->execute()){
                ...
                if ($result->num_rows <= 0){
                    ...
                    $_SESSION["loginId"] = $row_result[0];
                    $_SESSION["login"] = $row_result[1];
                    header("Location: index.php");
                }
            } else {
                $_SESSION["loginError"] = "Insert Failed - Server Error";
            }
            $stmt->close();
        }
    };
...
<body>
    ...
    <div class="alert alert-danger" role="alert">
        Login Gagal: <?= $_SESSION["loginError"] ?>
    </div>
    <?php 
