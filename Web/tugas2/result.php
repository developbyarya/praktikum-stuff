...
$isLogin = true;
$stmt_orders = $conn->prepare("INSERT INTO Orders (MenuId, temp, SizeId, sweetness, DiaryId, UserId) VALUES (?,?,?,?,?,?)");
$stmt_orders->bind_param("isisii", $_POST["menu"], $_POST["hot/ice"], $_POST['Size'], $_POST['sweetness'], $_POST['diary'], $_SESSION["loginId"]);
$stmt_orders->execute();
$result_id = $stmt_orders->insert_id;

$stmt_toppings = $conn->prepare("INSERT INTO OrderToppings (ToppingId, OrderId) VALUES (?,?)");
$toppings = $_POST['toppings'];
foreach ($toppings as $topping) {
    $stmt_toppings->bind_param("ii", $topping, $result_id);
...
<body>
    ...
    <div class="container w-75">
        ...
        <a href="/order.php" class="btn btn-primary text-center">Order Again</a>
